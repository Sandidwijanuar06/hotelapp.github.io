<?php
  ...
  $id_fas_kamar = $_GET['id'];
  $query = mysqli_query($con,"SELECT * FROM fasilitas_kamar WHERE id_fas_kamar='$id_fas_kamar'") or die(mysqli_error($con));
...
<head>
  ...
  <title>Resepsionis Page | Edit Fasilitas Kamar</title>
        ...
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title"><i class="fas fa-edit"> Edit Fasilitas Kamar</i></h3>
            </div>
            <div class="card-body">
            <form action="?id=<?=$_GET['id'];?>" method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" name="nama_fasilitas" class="form-control" value="<?=$sql['nama_fasilitas'];?>">
              </div>
              <div class="form-group">
                <label for="kualitas_fas_kamar">Kualitas Fasilitas</label>
                <input class="form-control" type="text" name="kualitas_fas_kamar" value="<?=$sql['kualitas_fas_kamar'];?>">
              </div>
              <div class="row">
                <div class="col-12">
                <a href="../detail/fas_kamar.php" class="btn btn-danger">Cancel</a>
                <button class="btn btn-success ml-10" type="submit" name="editfas">Update</button>
                </div>
              </div>
              </form>
            </div>
