<?php
  ...
  $id_kamar = $_GET['id'];
  $query = mysqli_query($con,"SELECT * FROM kamar WHERE id_kamar='$id_kamar'") or die(mysqli_error($con));
...
<head>
  ...
  <title>Resepsionis Page | Edit Kamar</title>
        ...
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title"><i class="fas fa-edit"> Edit Kamar</i></h3>
            </div>
            <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" name="nama_kamar" class="form-control" value="<?=$sql['nama_kamar'];?>">
              </div>
              <div class="form-group">
                <label for="jumlah_kamar">Jumlah Kamar</label>
                <input class="form-control" type="number" name="jumlah_kamar" value="<?=$sql['jumlah_kamar'];?>">
              </div>
              <div class="form-group">
                <label for="harga_kamar">Harga Kamar</label>
                <input class="form-control" type="number" name="harga_kamar" value="<?=$sql['harga_kamar'];?>">
              </div>
              <div class="form-group">
                <label for="foto_kamar">Foto Kamar</label>
                <input type="file" name="foto_kamar" class="form-control"> 
                <input type="hidden" name="foto_kamar_old" value="<?=$sql['foto_kamar'];?>" class="form-control"> 
              </div>
              <div class="row">
                <div class="col-12">
