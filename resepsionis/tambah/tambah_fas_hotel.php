...
<head>
  ...
  <title>Resepsionis Page | Tambah Fasilitas Hotel</title>
        ...
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title"><i class="fas fa-plus"> Tambah Fasilitas Hotel</i></h3>
            </div>
            <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="kualitas_fas_hotel" placeholder="Kualitas Fasilitas" required autofocus>
              </div>
              <div class="form-group">
                <label for="foto_fas_hotel">Foto Fasilitas</label>
                <input type="file" name="foto_fas_hotel" class="form-control" required autofocus> 
              </div>
              <div class="form-group">
                <label for="keterangan">keterangan Fasilitas</label><br>
               <textarea name="keterangan" cols="57" rows="5" required autofocus></textarea>
              </div>
              <div class="row">
                <div class="col-12">
                <a href="../fas_hotel.php" class="btn btn-danger">Cancel</a>
                <button class="btn btn-success ml-10" type="submit" name="tambahfashotel">Submit</button>
                </div>
              </div>
              </form>
            </div>
