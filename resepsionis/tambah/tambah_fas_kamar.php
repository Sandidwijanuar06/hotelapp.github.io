...
<head>
  ...
  <title>Resepsionis Page | Tambah Fasilitas Kamar</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tambah Fasilitas Kamar</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title"><i class="fas fa-plus"> Tambah Fasilitas Kamar</i></h3>
            </div>
            <div class="card-body">
            <form action="?id=<?=$_GET['id'];?>" method="post">
              <input type="hidden" name="id_kamar" value="<?=$data['id_kamar']?>" class="form-control" placeholder="Nama Fasilitas" required autofocus>
              <div class="form-group">
                <label for="nama_fasilitas">Nama Fasilitas</label>
                <input type="text" name="nama_fasilitas" class="form-control" placeholder="Nama Fasilitas" required autofocus>
              </div>
              <div class="form-group">
                <label for="kualitas_fas_kamar">Kualitas Fasilitas</label>
                <input class="form-control" type="text" name="kualitas_fas_kamar" placeholder="Kualitas Fasilitas" required autofocus>
              </div>
              <div class="row">
                <div class="col-12">
                <a href="../detail/fas_kamar.php" class="btn btn-danger">Cancel</a>
                <button class="btn btn-success ml-10" type="submit" name="tambahfas">Submit</button>
                </div>
              </div>
              </form>
            </div>
