...
<head>
  ...
  <title>Resepsionis Page | Tambah Kamar</title>
        ...
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title"><i class="fas fa-plus"> Tambah Kamar</i></h3>
            </div>
            <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label for="nama_kamar">Nama Kamar</label>
                <input type="text" name="nama_kamar" class="form-control" required autofocus>
              </div>
              <div class="form-group">
                <label for="jumlah_kamar">Jumlah Kamar</label>
                <input class="form-control" type="number" name="jumlah_kamar" required autofocus>
              </div>
              <div class="form-group">
                <label for="harga_kamar">Harga Kamar</label>
                <input class="form-control" type="number" name="harga_kamar" required autofocus>
              </div>
              <div class="form-group">
                <label for="foto_kamar">Foto Kamar</label>
                <input type="file" name="foto_kamar" class="form-control" required autofocus> 
              </div>
              <div class="form-group">
                <label for="keterangan">keterangan Kamar</label><br>
               <textarea name="keterangan" cols="57" rows="5" required autofocus></textarea>
              </div>
              <div class="row">
                <div class="col-12">
                <a href="../kamar.php" class="btn btn-danger">Cancel</a>
                <button class="btn btn-success ml-10" type="submit" name="tambah">Submit</button>
                </div>
              </div>
              </form>
            </div>
