<?php
  ...
  $id_pesan = $_GET['id'];
  $query = mysqli_query($con,"SELECT * FROM pemesanan WHERE pemesanan.id_pesan='$id_pesan'") or die(mysqli_error($con));
...
<head>
  ...
  <title>Resepsionis Page | Cetak Detail Pesanan</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Cetak Detail Pesanan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Cetak Detail Pesanan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="detail_pesan.php?id=<?=$data['id_pesan']?>" class="btn btn-primary float-right">Kembali</a>
                <h3 class="card-title">Tabel Detail Pesanan</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?= date('d F Y', strtotime($data['tgl_chekin']));?></td>
                      <td><?= date('d F Y', strtotime($data['tgl_checkout']));?></td>
                      <td><?= date('d F Y', strtotime($data['tgl_pesan']));?></td>
