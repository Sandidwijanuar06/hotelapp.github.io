...
<head>
  ...
  <title>Admin Page | Daftar Users</title>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?=$role?></td>
                      <td>
                        <a href="detail/detail_user.php?id=<?=$data['id_user']?>" class="btn btn-warning"><i class="fas fa-eye"></i></a>
                        <a href="edit/edit_user.php?id=<?=$data['id_user']?>" class="btn btn-success"><i class="fas fa-edit"></i></a>
                      </td>
                    </tr>
                    <?php
                      }
